...
class Base {
                ...
                for (const key of properties) {
                    ...
                    if (descriptor) {
                        ...
                        if (isCollection(value)) {
                            ...
                            batchable.pack(batchable_1.BatchType.save, batchID, _batch);
                        }
                    }
                }
                return _batch;
                ...
                for (const key of properties) {
                    ...
                    if (descriptor) {
                        ...
                        if (isCollection(value)) {
                            ...
                            collection.setParent(this, key);
                            const batchable = value;
                            batchable.pack(batchable_1.BatchType.update, batchID, _batch);
                        }
                    }
                }
                return _batch;
    ...
    save() {
        return __awaiter(this, void 0, void 0, function* () {
            const batch = this.pack(batchable_1.BatchType.save, UUID.v4());
            try {
    ...
    update() {
        return __awaiter(this, void 0, void 0, function* () {
            const batch = this.pack(batchable_1.BatchType.update, UUID.v4());
            try {
                const result = yield batch.commit();
